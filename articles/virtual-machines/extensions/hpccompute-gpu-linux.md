...
Instructions on manual installation of the drivers and the current supported versions are available. For more information including secure boot enabling setting, see [Azure N-series GPU driver setup for Linux](../linux/n-series-driver-setup.md).
